...
global.hubButton[0] = ini_read_real("Controls","Hub",vk_backspace);
global.confirmButton[0] = ini_read_real("Controls","Confirm",vk_enter);
global.bowButton[0] = ini_read_real("Controls","Bow",ord("B"));
global.skinLeftButton[0] = ini_read_real("Controls","Skin_left",ord("1"));
global.skinRightButton[0] = ini_read_real("Controls","Skin_right",ord("2"));
global.gimmickAButton[0] = ini_read_real("Controls","Gimmick_A",ord("X"));
global.gimmickBButton[0] = ini_read_real("Controls","Gimmick_B",ord("C"));
global.gimmickCButton[0] = ini_read_real("Controls","Gimmick_C",ord("V"));
