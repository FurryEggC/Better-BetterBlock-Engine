...
global.roomCaptionDef = "I Wanna Be The Better BetterBlock Engine";  //sets default window caption (only works with the Professional version of Studio)
...
global.startRoom = rTestRoom;    //sets which room to begin with
