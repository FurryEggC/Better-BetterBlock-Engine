...
global.roomCaptionDef = "Engine Pure Without Betterblock";  //sets default window caption (only works with the Professional version of Studio)
...
global.stageTotal = 10;  // 0(deafult), 1, 2, 3... ,n
